...
st.markdown("[github link](https://github.com/blackary/streamlit-image-coordinates/blob/main/pages/more_formats.py)")
st.markdown("[deployment link](https://image-coordinates.streamlit.app/more_formats)")
